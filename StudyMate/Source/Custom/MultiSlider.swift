...
// https://github.com/JK0369/ExSlider/blob/main/ExSlider/ViewController.swift

final class MultiSlider: UIControl {
    // MARK: Constant
    ...
    private let trackView: UIView = {
        let view = UIView()
        view.backgroundColor = Color.BaseColor.gray2
    ...
    var lowerThumbColor = Color.BaseColor.green {
        didSet { self.lowerThumbButton.backgroundColor = self.lowerThumbColor }
    }
    var upperThumbColor = Color.BaseColor.green {
...
//        didSet {
//            self.backgroundColor = self.isSelected ? Color.BaseColor.gray5 : Color.BaseColor.green
//        }
//    }
    
    override init(frame: CGRect) {
        super.init(frame: frame)
        self.backgroundColor = Color.BaseColor.green
        ...
        self.layer.borderColor = Color.BaseColor.white.cgColor
    }
    required init?(coder: NSCoder) {
        fatalError()
    }
